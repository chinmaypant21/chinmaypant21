...
🛠️ Contributing to open-source security tooling

🎓 MSc Cybersecurity

🧠 Passionate about **Securing AI** and cloud security at scale

---

#### Tech I work with

`Python` `JavaScript/TypeScript` `Docker` `Linux` `Nextjs` `Postgres` `SAST/DAST`
